...
class HtmlReport implements ReportType {
	...
	public HtmlReport(ReportSettings reportSettings, ReportTheme reportTheme) {
		...
		testLogPath = reportSettings.getReportPath() + Utility.getFileSeperator()
				+ "HTML Results" + Utility.getFileSeperator()
				+ reportSettings.getReportName() + ".html";

		resultSummaryPath = reportSettings.getReportPath()
				+ Utility.getFileSeperator() + "HTML Results"
				+ Utility.getFileSeperator() + "Summary" + ".html";
	}
	...
	@Override
	public void initializeTestLog() throws FrameworkException {
	...
	public void addTestLogSubHeading(String subHeading1, String subHeading2,
			String subHeading3, String subHeading4) throws FrameworkException {
		BufferedWriter bufferedWriter;
		try {
			bufferedWriter = new BufferedWriter(new FileWriter(testLogPath,
					true));
	...
	public void updateTestLog(String stepNumber, String stepName,
			String stepDescription, Status stepStatus, String screenShotName) throws FrameworkException {
		try {
			...
			case DONE:
				...
				"\t\t\t\t\t <td>" +
			 	...
			 	"\t\t\t\t\t <td>"
							+ "<small>"
							+ Utility.getCurrentFormattedTimeStamp(reportSettings
	...
	private String getTestStepWithoutScreenshot(String stepDescription,
		...
		testStepRow = "\t\t\t\t\t <td class='justified'>"
				...
				+ "\t\t\t\t\t <td>"
				+ "<small>"
				+ Utility.getCurrentFormattedTimeStamp(reportSettings.getDateFormatString()) + "</small>" + "</td> \n"
				+ "\t\t\t\t\t <td>" + " N/A " + "</td> \n"
				+ "\t\t\t\t </tr> \n";
	...
	public void addTestLogFooter(String executionTime, int nStepsPassed,
			int nStepsFailed) throws FrameworkException {
		try {
			BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(
					testLogPath, true));
	...
	@Override
	public void initializeResultSummary() throws FrameworkException {
	...
	public void addResultSummarySubHeading(String subHeading1,
			String subHeading2, String subHeading3, String subHeading4) throws FrameworkException {
		BufferedWriter bufferedWriter;
		try {
			bufferedWriter = new BufferedWriter(new FileWriter(
					resultSummaryPath, true));
	...
	public void updateResultSummary(TestParameters testParameters,
			String testReportName, String executionTime, String testStatus) throws FrameworkException {
		try {
			BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(
					resultSummaryPath, true));
			...
			String testcaseDescription = testParameters
					.getCurrentTestDesciption();
			String additionalDetails = testParameters.getAdditionDetails();
	...
	public void addResultSummaryFooter(String totalExecutionTime,
			int nTestsPassed, int nTestsFailed) throws FrameworkException {
		try {
